# -*- coding: utf-8 -*-
#
# fgpyo documentation build configuration file
#
...
rst_epilog = '''
.. _fgpyo: https://github.com/fulcrumgenomics/fgpyo
...
latex_documents = [
    ('index', 'fgpyo.tex', u'fgpyo documentation', u'Fulcrum Genomics', 'manual'),
]
