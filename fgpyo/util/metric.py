...
...     Person(name="Bob", age=24, address="North Pole")
... ]
>>> from pathlib import Path
>>> metrics_path = Path(getfixture("tmp_path")) / "metrics.txt"
>>> Person.write(metrics_path, *metrics)
...
>>> Person(name=Name(first='john', last='doe'), age=42).formatted_values()
['john doe', '42']
