...
def _assert_file_header_matches_metric(
    ...
    If `ordered_fieldnames` is specified, the fieldnames in the header must match this list exactly.
    Otherwise, the fieldnames in the header must match the fieldnames of the provided Metric.
